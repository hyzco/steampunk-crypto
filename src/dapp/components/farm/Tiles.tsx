  ...
  <>
    {fields.map((position, index) => (
      <>
        ...
        >
          <img alt="img" className="flowers" src={flower1} />
        </div>
        ...
        >
          {/* <img alt="img" className="flowers" src={lamp} /> */}
        </div>
        ...
        >
           {/* <img alt="img" className="leaves" src={grassLeaves2} /> */}
        </div>
        ...
        >
           {/* <img alt="img" className="leaves" src={grassLeaves1} /> */}
        </div>
        ...
        >
          {/* <img alt="img" className="rock1" src={rock1} /> */}
        </div>
        ...
        >
          {/* <img alt="img" className="rock1" src={rock2} /> */}
        </div>
      </>
    ))}
  </>
  ...
  return (
    <>
      ...
      <div style={{ gridColumn: "7/8", gridRow: "6/7" }}>
        <img alt="img" className="fence-horizontal" src={woodHorizontal} />
      </div>
      <div style={{ gridColumn: "8/9", gridRow: "6/7" }}>
        <img alt="img" className="fence-horizontal" src={woodHorizontal} />
      </div>
      <div style={{ gridColumn: "9/10", gridRow: "6/7" }}>
        <img alt="img" className="fence-post" src={woodPost} />
      </div>
      ...
      {/* <div style={{ gridColumn: "2/3", gridRow: "6/7" }}>
        <img alt="img" className="fence-half" src={woodHalf} />
      </div>
      ...
      <div style={{ gridColumn: "10", gridRow: "10/11" }}>
        <img alt="img" className="bucket" src={bucket} />
      </div>
      ...
      <div style={{ gridColumn: "5/6", gridRow: "3/4" }}>
         <img alt="img" className="lamp" src={lamp} />
      </div>

      <div style={{ gridColumn: "9/10", gridRow: "2/3" }}>
         <img alt="img" className="bear" src={bear} />
      </div>
      ...
      <div style={{ gridColumn: "10/11", gridRow: "4/5" }}>
         <img alt="img" className="bench" src={bench} />
      </div>
      ...
      <div style={{ gridColumn: "7/8", gridRow: "14/15" }}>
        <img alt="img" className="bridge" src={bridge} />
      </div>
