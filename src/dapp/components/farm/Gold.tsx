...
export const Gold: React.FC<Props> = ({ inventory }) => {
  ...
  const limit = inventory && Math.min(treeStrength, inventory["Iron Pickaxe"]);
    ...
    <>
      {ROCKS.map((gridPosition, index) => {
        ...
        return (
          ...
          >
            <img alt="img" src={rock} className="rock-mine ore" alt="tree" />
            ...
            <div className="gather-panel">
              ...
              <div className="resource-materials">
                ...
                {inventory["Iron Pickaxe"] < amount ? (
                  <Message>
                    You need a{" "}
                    <img alt="img" src={pickaxe} className="required-tool" />
                  </Message>
                ) : (
