...
contract Ownable {
  ...
  // modifier onlyOwner() {
  //     equire(minter == address(0) || msg.sender == minter, "You are not the minter");
...
contract TokenV2 is IERC20, Ownable, Pausable {
    ...
    address public devfeeWallet = address(0x35c074627e787c2f83A8B925AB29ff2805aBbf8D);
