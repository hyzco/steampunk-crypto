...
export interface AxeContract extends Truffle.Contract<AxeInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AxeInstance>;
}
...
export interface AxeInstance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
